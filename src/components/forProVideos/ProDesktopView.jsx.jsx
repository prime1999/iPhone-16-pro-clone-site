...
import { audioImg, horseFrameImg, horsevideoImg } from "../../utils";

const ProDesktopView = () => {
	return (
		<section className="w-full bg-black py-12 hidden lg:block">
			<div
				className="w-full h-[700px] text-white flex justify-center items-center max-lg:hidden section-target"
				style={{
					backgroundImage: `url(${horseFrameImg})`,
					backgroundSize: "250%",
					backgroundPosition: "center",
				}}
			>
				<h1 className="text-7xl font-semibold w-10/12 mx-auto text-center">
			...
			<div className="flex flex-col justify-center items-center">
				...
				<div className="w-10/12 mx-auto mt-12 lg:w-7/12 xl:w-8/12">
					<div className="w-full flex justify-between gap-32 text-xl text-gray items-start">
						...
						<p className="text-5xl font-semibold max-lg:text-xl w-full lg:w-9/12 xl:w-1/2">
							<span className="text-white">Highest-quality video</span> in a
							smartphone
						</p>
					</div>
					<div className="w-full text-gray mt-8 flex gap-32 justify-between items-start text-xl">
						<p className="w-9/12 xl:w-1/2">
							And now you can{" "}
							<span className="font-bold text-white">
			...
			<div className="mt-32">
				<div className="flex flex-col mx-auto text-white font-semibold w-full items-center justify-center text-5xl xl:text-7xl text-center">
					<h1 className="">Audio Mix.</h1>
					<h1>Make your voice heard.</h1>
					<p className="text-gray text-xl w-7/12 mt-16">
				...
				<div className="w-9/12 mx-auto mt-8 flex justify-between items-start gap-8 max-xl:justify-start">
