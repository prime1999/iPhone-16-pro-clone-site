...
const GetProVideos = () => {
	useEffect(() => {
		const tl = gsap.timeline({
			scrollTrigger: {
				...
				start: "top 10%",
				end: "+=400%", // 4x screen height scroll to complete
				scrub: true,
				pin: true,
			},
		});
	...
	return (
		<section className="w-full bg-black py-12 section-target">
			<div
			...
			<div className="flex flex-col justify-center items-center">
				<div className="w-[80vw] max-lg:hidden">
					<img
						src={horsevideoImg}
						alt="horse-video-image"
						className="w-full h-full object-cover"
					/>
					<p className="-mt-16 text-center text-sm text-gray max-lg:-mt-10">
						A herd of Icelandic horses, captured in stunning 4K 120 fps Dolby
						Vision
					</p>
				</div>
				{/* for the mobile and tablet screen */}
				<div className="relative w-[80vw] flex flex-col items-center lg:hidden section-target">
					...
					/>
					<h1 className="absolute top-[50%] opacity-1 text-3xl font-semibold w-8/12 mx-auto text-center text-white text-target lg:top-[20%]">
						4K 120 fps Dolby Vision. Cinemasterful.
					</h1>
					<p className="-mt-4 text-center text-sm text-gray max-lg:-mt-10 text">
						A herd of Icelandic horses, captured in stunning 4K 120 fps Dolby
						Vision
					</p>
				</div>
				<div className="w-10/12 mx-auto mt-12 lg:w-7/12 xl:w-8/12">
					<div className="w-full flex justify-between gap-32 text-xl text-gray items-start max-lg:flex-col max-lg:gap-8 max-lg:text-md">
